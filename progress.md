...
**Last updated:** 2026-07-10 (session 2; Pohang dataset prepared — IR letterboxed to 640×640, both modalities re-split into leakage-free per-run blocks, `scripts/audit_split.py` PASSES on real data; OQ-1/2/3 resolved, OQ-5 partial, OQ-9 added)
